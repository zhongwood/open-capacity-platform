...
//        sysUser.setId(user.getId());
    ...
    @GetMapping("/users/findOrgList")
    @LogAnnotation(module = "user-center", recordRequestParam = false)
    public PageResult<SysOrg> findOrgList(@RequestParam Map<String, Object> params) {
        return appUserService.findAllOrg(params);
    }
     ...
     * @return
     */
    @PostMapping("/users/saveOrUpdateOrg")
    @PreAuthorize("hasAnyAuthority('user:post/users/saveOrUpdate')")
    @LogAnnotation(module = "user-center", recordRequestParam = false)
    public Result saveOrUpdate(@RequestBody SysOrg sysOrg) {
        return appUserService.saveOrUpdate(sysOrg);
    }


    @PreAuthorize("hasAuthority('user:get/users')")
    @GetMapping("/users/findAllOrgs")
    @LogAnnotation(module = "user-center", recordRequestParam = false)
    public Result<SysOrg> findAllOrgs() {
        return appUserService.findAllOrgs();
    }

    @PreAuthorize("hasAuthority('user:get/users')")
    @GetMapping("/users/getOrgId")
    @LogAnnotation(module = "user-center", recordRequestParam = false)
    public Result getOrgId() {
        return Result.succeed(SysUserUtil.getLoginOrgId(), "操作成功");
